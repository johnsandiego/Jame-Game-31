...
public partial class SkillManager
{
    ...
    {
        {CardType.slime, new Skill("Sticky Slime", "Launches a sticky goo.", new Dictionary<string, int> { { "Damage", 10 } }, CardType.slime)},
        {CardType.skeleton, new Skill("Leg Bone", "A Leg bone that can tossed.", new Dictionary<string, int> { { "Damage", 20 } }, CardType.skeleton) },
        {CardType.troll, new Skill("Heal", "Restores health.", new Dictionary<string, int> { { "Damage", 30 }, { "Heal", 30 } }, CardType.troll)},
        {CardType.goblin, new Skill("Acid", "A weak acid that causes some burn.", new Dictionary<string, int> { { "Damage", 25 } }, CardType.goblin)},
        {CardType.vampire, new Skill("Blood Spike", "Spawns a bloody pool which shoots spikes", new Dictionary<string, int> { { "Damage", 50 } }, CardType.vampire)},
